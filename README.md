<div align="center">
  <h1>Enterprise application architecture in .NET</h1>
</div>
...
- Архитектура ПО
  - [DDD](#DDD)
  - [Архитектуры приложений](#architecture-types)
- Различие между уровнями (layers) и ярусами (tier):
  - [Многоуровневая и многоярусная архитектура](###multi-s)
  - [Плюсы и минусы разделения на ярусы (физического разделения)](###advantages-and-disadvantages)
  - [Улучшенная (современная) многоуровневая архитектура](###modern-multi-s)
...
### Архитектуры приложений: <a name="architecture-types"></a>
...
- _Ярус_ - это физический контейнер для кода, который относится к своему собственному пространству процесса или машины.
- Все уровни фактически разворачиваются на физическом уровне, но разные уровни могут состоять из разных ярусов.

### Многоуровневая и многоярусная архитектура <a name="multi-s"></a>
...
### Плюсы и минусы разделения на ярусы (физического разделения) <a name="advantages-and-disadvantages"></a>
...
### Улучшенная (современная) многоуровневая архитектура <a name="modern-multi-s"></a>
...
- Уровень предметной области
  - Содержит всю бизнес-логику, которая связана с одним или несколькими сценариями использования.
